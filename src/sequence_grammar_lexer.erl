...
-module(sequence_grammar_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/sequence_grammar_lexer.xrl", 20).
...
-file("src/sequence_grammar_lexer.erl", 284).
yystate() -> 12.
...
yystate(13, [10|Ics], Line, Tlen, _, _) ->
    yystate(13, Ics, Line+1, Tlen+1, 10, Tlen);
...
-file("src/sequence_grammar_lexer.xrl", 6).
yyaction_0(TokenChars, TokenLine) ->
     { token, { segment, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/1}).
-file("src/sequence_grammar_lexer.xrl", 7).
yyaction_1(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/sequence_grammar_lexer.xrl", 8).
yyaction_2(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/sequence_grammar_lexer.xrl", 9).
yyaction_3(TokenLine) ->
     { token, { '<', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/sequence_grammar_lexer.xrl", 10).
yyaction_4(TokenLine) ->
     { token, { '>', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/sequence_grammar_lexer.xrl", 11).
yyaction_5(TokenLine) ->
     { token, { '{', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/sequence_grammar_lexer.xrl", 12).
yyaction_6(TokenLine) ->
     { token, { '}', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/sequence_grammar_lexer.xrl", 13).
yyaction_7(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/sequence_grammar_lexer.xrl", 14).
yyaction_8(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/sequence_grammar_lexer.xrl", 15).
yyaction_9(TokenLine) ->
     { token, { '|', TokenLine } } .

-compile({inline,yyaction_10/0}).
-file("src/sequence_grammar_lexer.xrl", 16).
yyaction_10() ->
     skip_token .
